fun main() {
    ...
    val paymentMethod: String = "Мир"
    val totalMonthPayments: Float = 0F
    println(comissionCalculate(paymentAmount = payment, paymentMethod = paymentMethod, totalMonthPayments = totalMonthPayments))
}
...
fun vkPay(amount: Int, totalMonthPayments: Float = 0F): Float {           //Доступен ли платеж через VKpay
    ...
    val maxSendMonth: Int = 40_000 //Максимум отправленых средств за месяц
